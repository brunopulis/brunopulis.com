...
Na [NTT Data](https://www.everis.com/brazil), temos um time com cerca de 70 profissionais dedicados em tempo integral pela acessibilidade. Nossa tendência é crescer mais.
...
Nosso cotidiano é um pouco diferente, além de seguirmos as boas práticas de testes e técnicas, utilizamos a [WCAG](https://www.w3.org/WAI/standards-guidelines/wcag/#intro), que é nosso norte para reportar as inconsistências relacionadas à acessibilidade.
...
Para validarmos usamos como norte a [WCAG](https://www.w3.org/WAI/standards-guidelines/wcag/#intro) , um documento da W3C, que contém as diretrizes de acessibilidade. Nossos testes são baseados em:
...
- O [Guia WCAG](https://guia-wcag.com), uma referência rápida para consultar as diretrizes de acessibilidade;
...
Recentemente fiz um curso de "QA de acessibilidade" pela [INSEP](https://insep.org.br/), o [Maurício Pereiro](https://www.linkedin.com/in/mauricio-pereiro/) um dos instrutores, comentou que a projeção desses profissionais irá crescer exponencialmente.
