...
![Listagem de notícias com imagem e título do artigo.](/images/the-verge-1024x470.png)
...
- O nome do fotográfo. Isso é bem comum, mas não faz sentido.
...
Se o ícone do menu tiver um label, você deve deixar o texto alternativo em branco. Muitas vezes eu encontro botões de menu que são lidos como “Menu Menu”. Uma vez, encontrei um "menu menu hamburger". Um pouco confuso, não diria?
...
Facebook e Instagram, atualmente incluiram uma feature que descreve imagens automaticamente. Mas eu percebo que as descrições são muito genéricas. Uma imagem no meu feed agora é descrita como: “Gatos dentro de casa”. A foto atual exibe um gato caçando um rato de brinquedo.
