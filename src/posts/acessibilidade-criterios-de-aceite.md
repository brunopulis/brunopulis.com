...
Foi dada a largada de mais uma sprint, como um bom analista de qualidade você inicia os preparativos para manter seu trabalho e do time de forma organizada, clara e documentada, visando cobrir todas as etapas de desenvolvimento.

Na etapa de análise de requisitos, percebe que o produto não está conformidade as diretrizes de acessibilidade, por consequencia, o produto quebra um dos pilares da qualidade descritos na **ISO 25010**. O que fazer nessa situação?

Nesse artigo vou dar algumas dicas de como **você**, pode contribuir para a definição de critérios de aceitação, pensando em acessibilidade.
...
Num ambiente ágil, ocorre a famosa reunião dos **_Three Amigos_**, onde _PO_, _QA_ e líder técnico fazem o refinamento de funcionalidades que são candidatas para uma sprint.

O objetivo dessa reunião e ter um prisma do mesmo problema em aspectos diferentes. O negócio exige determinados aspectos, enquanto o líder técnico apresenta as possibilidades de desenvolvimento. Em contrapartida, nós analistas de qualidade visamos criticar o produto e levantar cenários de testes funcionais e não funcionais.
...
![Exemplo de uma modal, contendo um formulário de Endereço de entrega.](/images/modal.png)
...
- W3C, 2021. Disponível em: [https://www.w3.org/TR/wai-aria-practices-1.1/examples/dialog-modal/dialog.html](https://www.w3.org/TR/wai-aria-practices-1.1/examples/dialog-modal/dialog.html). Acesso em: 23 de Abril de 2021.
