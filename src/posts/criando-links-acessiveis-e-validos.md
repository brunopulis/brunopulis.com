---
title: "Como criar links acessíveis"
date: "2019-04-21"
categories: 
...
O elemento de âncora ou link são frequentemente citados como o principal bloco de construção da Internet. Ele é utilizado para criar um link para outras páginas, para âncoras na mesma página, para outros recursos (como um PDF) ou para um endereço de e-mail.

Como podemos ter certeza que eles são acessíveis a todos?
...
- um **atributo `href`**;
- a localização da âncora, página ou recurso;
- **conteúdo do link**;
- texto descrevendo para onde o link está indo, pode ser um texto simples ou o `atributo alt` de uma imagem;
...
- [Links, Botões, Submits, e Divs, Oh Hell](http://adrianroselli.com/2016/01/links-buttons-submits-and-divs-oh-hell.html) - Adrian Roselli
