...
<main id="content">
    ...
    <div class="container">
      <div class="row">
        <div class="col-lg-12">
          ...
          <h2>Marcas que confiaram no meu trabalho</h2>
          <ul class="list-grid">
            <li>
              <img src="<?php echo TEMPLATE_PATH; ?>/assets/images/clients/cotemig.png" loading="lazy" class="img-fluid">
            </li>
            <li>
              <img src="<?php echo TEMPLATE_PATH; ?>/assets/images/clients/uni-bh.svg" loading="lazy" class="img-fluid">
            </li>
            <li>
              <img src="<?php echo TEMPLATE_PATH; ?>/assets/images/clients/una.svg" loading="lazy" class="img-fluid">
            </li>
            <li>
            <img src="<?php echo TEMPLATE_PATH; ?>/assets/images/clients/estacio.svg" loading="lazy" class="img-fluid">
            </li>
          </ul>
        </div>
      </div>
    ...
    <header class="section__header" role="banner">
      <div class="container">
        <div class="section__wrap">
          <h2 class="section-title" id="testimonials-title">Palestras anteriores</h2>
        </div>
      </div>
    </header>
    <div class="container">
  ...
  <?php require_once('template-parts/components/home-blog.php'); ?>
